...
print(f"[*] Starting PSH+ACK Flood -> {TARGET_IP}:{TARGET_PORT}")
...
for f in range(FLOWS):
    ...
    # PSH+ACK carries real data — larger payloads than SYN/ACK floods
    size_min = random.randint(100, 400)
    size_max = random.randint(size_min + 200, 1400)
