...
for f in range(FLOWS):
    ...
    size_max = random.randint(size_min + 20, 200)
    ...
    for p in range(packets):
        ...
        pkt = IP(
            # NO src — Scapy uses real Kali IP = DoS
            dst = TARGET_IP,
            ttl = ttl,
